...
public:
    ...
    void setupUi(QMainWindow *RegWindowN)
    {
        ...
        RegWindowN->resize(600, 600);
        RegWindowN->setMinimumSize(QSize(600, 600));
        RegWindowN->setMaximumSize(QSize(600, 600));
        centralwidget = new QWidget(RegWindowN);
        centralwidget->setObjectName("centralwidget");
        name = new QLineEdit(centralwidget);
        name->setObjectName("name");
        name->setGeometry(QRect(200, 130, 201, 31));
        phoneNumber = new QLineEdit(centralwidget);
        phoneNumber->setObjectName("phoneNumber");
        phoneNumber->setGeometry(QRect(200, 250, 201, 31));
        address = new QLineEdit(centralwidget);
        address->setObjectName("address");
        address->setGeometry(QRect(200, 210, 201, 31));
